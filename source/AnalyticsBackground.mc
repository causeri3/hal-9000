...
class AnalyticsBackground extends System.ServiceDelegate {
    ...
    const ENDPOINT = "https://tvsvdqiqfjywgzeozwxf.supabase.co/functions/v1/hal";
    ...
    function onTemporalEvent() as Void {
        ...
        //     if (i > 0) { eventTypes += ", "; }
        //     eventTypes += (queue[i] as Dictionary)["event"];
        // }
        // System.println("AnalyticsBackground: posting batch size=" + queue.size() + " events=[" + eventTypes + "]");
        //
